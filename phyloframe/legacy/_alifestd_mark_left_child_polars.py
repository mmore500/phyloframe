...
def alifestd_mark_left_child_polars(
    ...
    logging.info(
        "- alifestd_mark_left_child_polars: adding ancestor_id col...",
    )
    ...
    logging.info(
        "- alifestd_mark_left_child_polars: checking contiguous ids...",
    )
    if not alifestd_has_contiguous_ids_polars(phylogeny_df):
        phylogeny_df = alifestd_assign_contiguous_ids_polars(phylogeny_df)

    logging.info(
        "- alifestd_mark_left_child_polars: checking topological sort...",
    )
    ...
    logging.info(
        "- alifestd_mark_left_child_polars: extracting ancestor ids...",
    )
    ancestor_ids = (
        phylogeny_df.lazy()
        .select("ancestor_id")
    ...
    result = _alifestd_mark_left_child_asexual_fast_path(ancestor_ids)

    return phylogeny_df.with_columns(
        left_child_id=result,
    )
