...
from .._auxlib._jit_numpy_uint8_t import jit_numpy_uint8_t
...
def _alifestd_collapse_unifurcations_asexual(
    ...
    keep_filter, ancestor_ids = _collapse_unifurcations(
        phylogeny_df["ancestor_id"].to_numpy(copy=True),  # pandas 3.x compat
    )
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_collapse_unifurcations",
