...
def alifestd_mark_lineage_cumprod_polars(
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_lineage_cumprod_polars",
...
if __name__ == "__main__":
    ...
    try:
        with log_context_duration(
            "phyloframe.legacy._alifestd_mark_lineage_cumprod_polars",
            logging.info,
        ):
            _run_dataframe_cli(
                base_parser=parser,
