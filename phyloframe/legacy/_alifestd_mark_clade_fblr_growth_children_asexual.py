...
from .._auxlib._fit_fblr import fit_fblr
from .._auxlib._format_cli_description import format_cli_description
from .._auxlib._get_phyloframe_version import get_phyloframe_version
from .._auxlib._log_context_duration import log_context_duration
from .._auxlib._warn_once import warn_once
...
def alifestd_mark_clade_fblr_growth_children_asexual(
    ...
    mutate: bool = False,
    *,
    mark_as: str = "clade_fblr_growth_children",
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_clade_fblr_growth_children_asexual",
    ...
    parser.add_argument(
        "--mark-as",
        default="clade_fblr_growth_children",
        type=str,
        help="output column name (default: clade_fblr_growth_children)",
    )
    return parser
