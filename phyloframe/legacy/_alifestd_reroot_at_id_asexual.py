...
from .._auxlib._pairwise import pairwise
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_reroot_at_id_asexual",
...
if __name__ == "__main__":
    ...
    with log_context_duration(
        "phyloframe.legacy._alifestd_reroot_at_id_asexual", logging.info
    ):
        _run_dataframe_cli(
            base_parser=parser,
