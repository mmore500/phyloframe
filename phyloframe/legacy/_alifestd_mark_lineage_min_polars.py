...
from ._alifestd_mark_lineage_cumsum_asexual import _OP_MIN
from ._alifestd_mark_lineage_cumsum_polars import (
    _alifestd_mark_lineage_op_polars,
)


def alifestd_mark_lineage_min_polars(
    phylogeny_df: pl.DataFrame,
    values: typing.Union[str, pl.Expr],
    *,
    mark_as: str = "lineage_min",
    reverse: bool = False,
    skipna: bool = True,
) -> pl.DataFrame:
...
See Also
========
phyloframe.legacy._alifestd_mark_lineage_min_asexual :
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_lineage_min_polars",
    ...
    parser.add_argument(
        ...
        default="lineage_min",
        type=str,
        help="output column name (default: lineage_min)",
    )
    parser.add_argument(
        "--reverse",
        action="store_true",
...
if __name__ == "__main__":
    ...
    try:
        with log_context_duration(
            "phyloframe.legacy._alifestd_mark_lineage_min_polars",
            logging.info,
        ):
            _run_dataframe_cli(
                base_parser=parser,
