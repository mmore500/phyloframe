...
def alifestd_mark_clade_logistic_growth_sister_asexual(
    ...
    mutate: bool = False,
    *,
    mark_as: str = "clade_logistic_growth_sister",
...
Add column `clade_logistic_growth_sister`, containing the coefficient of a logistic regression fit comparing origin times of this clade's descendant leaves to those of its sister clade.
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_clade_logistic_growth_sister_asexual",
    ...
    parser.add_argument(
        "--mark-as",
        default="clade_logistic_growth_sister",
        type=str,
        help="output column name (default: clade_logistic_growth_sister)",
    )
    return parser
