...
def alifestd_mark_next_sibling_id_polars(
    ...
    logging.info(
        "- alifestd_mark_next_sibling_id_polars: checking topological sort...",
    )
    ...
    logging.info(
        "- alifestd_mark_next_sibling_id_polars: tabulating next sibling ids...",
    )
    ...
    return phylogeny_df.with_columns(
        next_sibling_id=next_sibling_ids,
    )
...
if __name__ == "__main__":
    ...
    try:
        with log_context_duration(
            ...
            _run_dataframe_cli(
                base_parser=parser,
                output_dataframe_op=alifestd_mark_next_sibling_id_polars,
            )
