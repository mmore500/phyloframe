...
from ._alifestd_mark_lineage_cumsum_asexual import (
    _OP_SUM,
    _alifestd_mark_lineage_op_asexual_fast_path,
)
...
def _alifestd_mark_lineage_op_polars(
    ...
    *,
    ...
    """Shared implementation for all lineage op marks (polars)."""
    ...
    if "ancestor_id" not in schema_names:
        raise NotImplementedError(
            "alifestd_mark_lineage_*_polars only supports asexual "
            "phylogenies.",
        )
    if not alifestd_is_asexual_polars(phylogeny_df):
        raise NotImplementedError(
            "alifestd_mark_lineage_*_polars only supports asexual "
            "phylogenies.",
        )
    ...
    result = _alifestd_mark_lineage_op_asexual_fast_path(
        ancestor_ids,
        value_arr,
        op_code,
        reverse,
