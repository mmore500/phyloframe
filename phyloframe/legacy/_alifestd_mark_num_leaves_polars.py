...
def alifestd_mark_num_leaves_polars(
    ...
    logging.info(
        "- alifestd_mark_num_leaves_polars: checking contiguous ids...",
    )
    if not alifestd_has_contiguous_ids_polars(phylogeny_df):
        phylogeny_df = alifestd_assign_contiguous_ids_polars(phylogeny_df)

    logging.info(
        "- alifestd_mark_num_leaves_polars: checking topological sort...",
    )
    ...
    logging.info(
        "- alifestd_mark_num_leaves_polars: extracting ancestor ids...",
    )
    ancestor_ids = (
        phylogeny_df.lazy()
        .select("ancestor_id")
    ...
    logging.info(
        "- alifestd_mark_num_leaves_polars: tabulating leaf counts...",
    )
