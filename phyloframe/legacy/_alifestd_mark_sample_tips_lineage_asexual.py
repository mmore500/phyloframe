...
def alifestd_mark_sample_tips_lineage_asexual(
    ...
    *,
    ...
    mark_as : str, default "alifestd_mark_sample_tips_lineage_asexual"
    ...
    if "ancestor_id" not in phylogeny_df.columns:
        raise ValueError(
            "alifestd_mark_sample_tips_lineage_asexual only supports "
            "asexual phylogenies.",
        )

    logging.info(
        "- alifestd_mark_sample_tips_lineage_asexual: marking leaves...",
    )
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_sample_tips_lineage_asexual",
    ...
    parser.add_argument(
        "--mark-as",
        default="alifestd_mark_sample_tips_lineage_asexual",
        type=str,
        help="Column name for the boolean mark (default: alifestd_mark_sample_tips_lineage_asexual).",
    )
    add_bool_arg(
        parser,
