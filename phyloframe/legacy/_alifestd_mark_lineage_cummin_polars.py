...
from ._alifestd_mark_lineage_cummin_asexual import (
    _alifestd_mark_lineage_cummin_asexual_fast_path,
)
...
def alifestd_mark_lineage_cummin_polars(
    ...
    *,
    ...
    if "ancestor_id" not in schema_names:
        raise NotImplementedError(
            "alifestd_mark_lineage_cummin_polars only supports asexual "
            "phylogenies.",
        )
    ...
    result = _alifestd_mark_lineage_cummin_asexual_fast_path(
        ancestor_ids,
        values_arr,
        reverse,
    )
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_mark_lineage_cummin_polars",
...
if __name__ == "__main__":
    ...
    try:
        with log_context_duration(
            "phyloframe.legacy._alifestd_mark_lineage_cummin_polars",
            logging.info,
        ):
            _run_dataframe_cli(
                base_parser=parser,
