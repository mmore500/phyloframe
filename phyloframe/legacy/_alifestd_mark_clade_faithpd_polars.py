...
def alifestd_mark_clade_faithpd_polars(
    ...
    logging.info(
        "- alifestd_mark_clade_faithpd_polars: adding ancestor_id col...",
    )
    ...
    logging.info(
        "- alifestd_mark_clade_faithpd_polars: checking contiguous ids...",
    )
    if not alifestd_has_contiguous_ids_polars(phylogeny_df):
        phylogeny_df = alifestd_assign_contiguous_ids_polars(phylogeny_df)

    logging.info(
        "- alifestd_mark_clade_faithpd_polars: checking topological sort...",
    )
    ...
    logging.info(
        "- alifestd_mark_clade_faithpd_polars: extracting arrays...",
    )
    ancestor_ids = (
        phylogeny_df.lazy()
        .select("ancestor_id")
    ...
    result = _alifestd_mark_clade_faithpd_asexual_fast_path(
        ancestor_ids,
        origin_time_deltas,
    )

    return phylogeny_df.with_columns(
        clade_faithpd=result,
    )
