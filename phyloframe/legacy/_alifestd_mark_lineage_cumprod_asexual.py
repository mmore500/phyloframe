...
@jit(nopython=True)
def _alifestd_mark_lineage_cumprod_asexual_fast_path(
    ancestor_ids: np.ndarray,
    values: np.ndarray,
    reverse: bool,
) -> np.ndarray:
    """Implementation detail for `alifestd_mark_lineage_cumprod_asexual`."""
...
def alifestd_mark_lineage_cumprod_asexual(
    ...
    *,
    ...
    phylogeny_df[mark_as] = _alifestd_mark_lineage_cumprod_asexual_fast_path(
