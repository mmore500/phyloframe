...
def alifestd_prune_extinct_lineages_polars(
    ...
    logging.info(
        "- alifestd_prune_extinct_lineages_polars: checking contiguous ids...",
    )
    ...
    logging.info(
        "- alifestd_prune_extinct_lineages_polars: checking topological sort...",
    )
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = _add_parser_base(
        parser=parser,
        dfcli_module="phyloframe.legacy._alifestd_prune_extinct_lineages_polars",
