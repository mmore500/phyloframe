...
$ python3 -m phyloframe.legacy._alifestd_mark_csr_children_asexual
$ python3 -m phyloframe.legacy._alifestd_mark_csr_children_polars
...
$ python3 -m phyloframe.legacy._alifestd_mark_lineage_max_asexual
$ python3 -m phyloframe.legacy._alifestd_mark_lineage_max_polars
$ python3 -m phyloframe.legacy._alifestd_mark_lineage_min_asexual
$ python3 -m phyloframe.legacy._alifestd_mark_lineage_min_polars
