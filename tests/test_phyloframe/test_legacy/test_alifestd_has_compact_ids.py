...
def test_alifestd_has_compact_ids_true(phylogeny_df):
    phylogeny_df_ = phylogeny_df.copy()
    assert alifestd_has_compact_ids(phylogeny_df)
...
def test_alifestd_has_compact_ids_false(phylogeny_df):
    phylogeny_df_ = phylogeny_df.copy()
    assert not alifestd_has_compact_ids(phylogeny_df)
    # check for side effects
    assert phylogeny_df.equals(phylogeny_df_)
