...
@pytest.mark.parametrize("n_sample", [None, 4])
def test_alifestd_mark_sample_tips_lineage_stratified_asexual(n_sample):
    ...
    result = alifestd_mark_sample_tips_lineage_stratified_asexual(
        phylogeny_df, n_sample=n_sample, seed=1
    )
...
def test_alifestd_mark_sample_tips_lineage_stratified_asexual_mark_as():
    ...
    result = alifestd_mark_sample_tips_lineage_stratified_asexual(
        phylogeny_df, n_sample=4, seed=1, mark_as="my_col"
    )
