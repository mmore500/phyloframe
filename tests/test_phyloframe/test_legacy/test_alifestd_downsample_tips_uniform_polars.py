...
from phyloframe.legacy._alifestd_downsample_tips_uniform_asexual import (
    alifestd_downsample_tips_uniform_asexual,
)
from phyloframe.legacy._alifestd_downsample_tips_uniform_polars import (
    alifestd_downsample_tips_uniform_polars as alifestd_downsample_tips_uniform_polars_,
)
...
alifestd_downsample_tips_uniform_polars = enforce_dtype_stability_polars(
    alifestd_downsample_tips_uniform_polars_
)
...
def test_alifestd_downsample_tips_uniform_polars(
...
def test_alifestd_downsample_tips_uniform_polars_empty(
...
def test_alifestd_downsample_tips_uniform_polars_matches_pandas(
    phylogeny_df: pd.DataFrame,
    n_downsample: int,
    seed: int,
    apply: typing.Callable,
...
def test_alifestd_downsample_tips_uniform_polars_deterministic(
    phylogeny_df: pd.DataFrame,
    seed: int,
    apply: typing.Callable,
):
...
def test_alifestd_downsample_tips_uniform_polars_no_ancestor_id(
    apply: typing.Callable,
):
    df = apply(
        pl.DataFrame(
    ...
    alifestd_downsample_tips_uniform_polars(df, 1)
...
def test_alifestd_downsample_tips_uniform_polars_simple(
    apply: typing.Callable,
):
    ...
    result = (
        alifestd_downsample_tips_uniform_polars(df, 1, seed=1).lazy().collect()
    )
...
def test_alifestd_downsample_tips_uniform_polars_all_tips(
    apply: typing.Callable,
):
