...
from phyloframe.legacy import (
    alifestd_mark_colless_like_index_mdm_asexual as alifestd_mark_colless_like_index_mdm_asexual_,
)
from phyloframe.legacy import (
...
alifestd_mark_colless_like_index_mdm_asexual = enforce_dtype_stability_pandas(
