...
from phyloframe.legacy import (
    alifestd_mark_clade_logistic_growth_children_asexual as alifestd_mark_clade_logistic_growth_children_asexual_,
)
from phyloframe.legacy import (
...
alifestd_mark_clade_logistic_growth_children_asexual = assert_dtype_consistency(alifestd_mark_clade_logistic_growth_children_asexual_)
