...
def test_empty_df():
    assert alifestd_count_leaf_nodes(alifestd_make_empty()) == 0
...
def test_singleton_df():
    ...
    assert alifestd_count_leaf_nodes(df) == 1
...
def test_sexual_df1():
    ...
    assert alifestd_count_leaf_nodes(df) == 3
...
def test_multiple_trees_df2():
    ...
    assert alifestd_count_leaf_nodes(df) == 2
