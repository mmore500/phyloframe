...
from phyloframe.legacy._alifestd_mark_leaves_polars import (
    alifestd_mark_leaves_polars as alifestd_mark_leaves_polars_,
)

from ._impl import enforce_dtype_stability_polars

alifestd_mark_leaves_polars = enforce_dtype_stability_polars(
    alifestd_mark_leaves_polars_
)
...
def test_alifestd_mark_leaves_polars_matches_pandas(
    ...
    result_pd = alifestd_mark_leaves(phylogeny_df, mutate=False)
