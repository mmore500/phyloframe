...
from phyloframe.legacy import (
    alifestd_mark_clade_duration_asexual as alifestd_mark_clade_duration_asexual_,
)

from ._impl import enforce_dtype_stability_pandas

alifestd_mark_clade_duration_asexual = enforce_dtype_stability_pandas(
    alifestd_mark_clade_duration_asexual_
)
