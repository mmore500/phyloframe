...
from phyloframe.legacy._alifestd_unfurl_traversal_postorder_contiguous_asexual import (
...
def test_empty():
    ...
    result = _alifestd_unfurl_traversal_postorder_contiguous_asexual_jit(
        ancestor_ids,
    )
    assert len(result) == 0
