...
def test_alifestd_downsample_tips_clade_asexual_cli_csv():
    output_file = "/tmp/phyloframe_alifestd_downsample_tips_clade_asexual.csv"  # nosec B108
...
def test_alifestd_downsample_tips_clade_asexual_cli_parquet():
    output_file = "/tmp/phyloframe_alifestd_downsample_tips_clade_asexual.pqt"  # nosec B108
    pathlib.Path(output_file).unlink(missing_ok=True)
    subprocess.run(  # nosec B603
        [
            "python3",
...
def test_alifestd_downsample_tips_clade_asexual_cli_ignore_topological_sensitivity():
    output_file = "/tmp/phyloframe_alifestd_downsample_tips_clade_asexual_ignore.csv"  # nosec B108
    pathlib.Path(output_file).unlink(missing_ok=True)
    subprocess.run(  # nosec B603
        [
            "python3",
...
def test_alifestd_downsample_tips_clade_asexual_cli_drop_topological_sensitivity():
    output_file = "/tmp/phyloframe_alifestd_downsample_tips_clade_asexual_drop.csv"  # nosec B108
    pathlib.Path(output_file).unlink(missing_ok=True)
    subprocess.run(  # nosec B603
        [
            "python3",
