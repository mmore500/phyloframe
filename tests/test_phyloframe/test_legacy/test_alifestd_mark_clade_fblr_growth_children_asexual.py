...
alifestd_mark_clade_fblr_growth_children_asexual = assert_dtype_consistency(alifestd_mark_clade_fblr_growth_children_asexual_)
...
def test_empty():
    ...
    res = alifestd_mark_clade_fblr_growth_children_asexual(
        phylogeny_df,
    )
    assert len(res) == 0
...
def test_simple2(mutate: bool, parallel_backend: typing.Optional[str]):
    ...
    original_df = phylogeny_df.copy()
    result_df = alifestd_mark_clade_fblr_growth_children_asexual(
        phylogeny_df,
        mutate=mutate,
        parallel_backend=parallel_backend,
    )
    result_df.index = result_df["id"]
    assert math.isnan(result_df.loc[3, "clade_fblr_growth_children"])
    assert result_df.loc[0, "clade_fblr_growth_children"] < 0
    assert result_df.loc[1, "clade_fblr_growth_children"] < 0
    assert math.isnan(result_df.loc[2, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[4, "clade_fblr_growth_children"])
...
def test_simple4(
    ...
    assert result_df.loc[0, "clade_fblr_growth_children"] > 0
    assert result_df.loc[1, "clade_fblr_growth_children"] < 0
    assert result_df.loc[2, "clade_fblr_growth_children"] > 0
    assert math.isnan(result_df.loc[3, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[4, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[5, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[6, "clade_fblr_growth_children"])
...
def test_simple5(
    ...
    assert math.isnan(result_df.loc[2, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[3, "clade_fblr_growth_children"])
    assert result_df.loc[4, "clade_fblr_growth_children"] > 0
    assert math.isnan(result_df.loc[5, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[6, "clade_fblr_growth_children"])
...
def test_simple6(
    ...
    result_df.index = result_df["id"]
    assert math.isnan(result_df.loc[0, "clade_fblr_growth_children"])
...
def test_simple8(mutate: bool, parallel_backend: typing.Optional[str]):
    ...
    result_df.index = result_df["id"]
    assert math.isnan(result_df.loc[1, "clade_fblr_growth_children"])
...
def test_simple10(
    ...
    assert result_df.loc[0, "clade_fblr_growth_children"] == _0
    assert result_df.loc[1, "clade_fblr_growth_children"] == _0
    assert math.isnan(result_df.loc[2, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[3, "clade_fblr_growth_children"])
    assert result_df.loc[4, "clade_fblr_growth_children"] == _0
    assert math.isnan(result_df.loc[5, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[6, "clade_fblr_growth_children"])
...
def test_simple13(mutate: bool, parallel_backend: typing.Optional[str]):
    ...
    assert result_df.loc[0, "clade_fblr_growth_children"] < 0
    assert result_df.loc[1, "clade_fblr_growth_children"] < 0
    assert math.isnan(result_df.loc[22, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[4, "clade_fblr_growth_children"])
...
def test_simple14(mutate: bool, parallel_backend: typing.Optional[str]):
    ...
    result_df.index = result_df["id"]
    assert math.isnan(result_df.loc[3, "clade_fblr_growth_children"])
    assert result_df.loc[100, "clade_fblr_growth_children"] < 0
    assert result_df.loc[1, "clade_fblr_growth_children"] > 0
    assert math.isnan(result_df.loc[22, "clade_fblr_growth_children"])
    assert math.isnan(result_df.loc[4, "clade_fblr_growth_children"])
...
def test_fuzz(
    ...
    # Verify result_df
    assert "clade_fblr_growth_children" in result_df.columns
    assert len(result_df) == len(phylogeny_df)

    result_df = alifestd_mark_leaves(result_df)
    assert (
        result_df["clade_fblr_growth_children"].isna() == result_df["is_leaf"]
    ).all()
