...
from phyloframe.legacy import (
    alifestd_mark_sister_asexual as alifestd_mark_sister_asexual_,
)

from ._impl import enforce_dtype_stability_pandas

alifestd_mark_sister_asexual = enforce_dtype_stability_pandas(
    alifestd_mark_sister_asexual_
)
...
def test_simple1(mutate: bool):
    ...
    assert result_df.loc[0, "sister_id"] == 0
    assert result_df.loc[1, "sister_id"] == 2
    assert result_df.loc[2, "sister_id"] == 1
...
def test_simple5(mutate: bool):
    ...
    assert result_df.loc[0, "sister_id"] == 0
    assert result_df.loc[2, "sister_id"] == 1
    assert result_df.loc[3, "sister_id"] == 4
    assert result_df.loc[4, "sister_id"] == 3
...
def test_simple6(mutate: bool):
    ...
    result_df.index = result_df["id"]
    assert result_df.loc[1, "sister_id"] == 1
    assert result_df.loc[0, "sister_id"] == 0
