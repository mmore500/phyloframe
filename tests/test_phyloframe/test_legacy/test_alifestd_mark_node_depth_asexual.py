...
from phyloframe.legacy import (
    alifestd_mark_node_depth_asexual as alifestd_mark_node_depth_asexual_,
)
from phyloframe.legacy import (
    alifestd_validate,
)
...
alifestd_mark_node_depth_asexual = enforce_dtype_stability_pandas(
    alifestd_mark_node_depth_asexual_
)
