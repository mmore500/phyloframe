...
@pytest.mark.parametrize("n_downsample", [1, pytest.param(5, marks=pytest.mark.heavy), 10, 100000000])
...
@pytest.mark.parametrize("n_downsample", [1, pytest.param(5, marks=pytest.mark.heavy), 10])
@pytest.mark.parametrize("seed", [1, pytest.param(42, marks=pytest.mark.heavy)])
