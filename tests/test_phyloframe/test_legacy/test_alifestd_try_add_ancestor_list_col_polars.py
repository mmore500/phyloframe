...
from phyloframe.legacy._alifestd_make_ancestor_list_col_polars import (
...
alifestd_try_add_ancestor_list_col_polars = enforce_dtype_stability_polars(
    alifestd_try_add_ancestor_list_col_polars_
)
