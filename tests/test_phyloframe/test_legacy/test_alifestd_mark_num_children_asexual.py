...
from phyloframe.legacy import (
    alifestd_mark_num_children_asexual as alifestd_mark_num_children_asexual_,
)
from phyloframe.legacy import (
    alifestd_validate,
)
...
alifestd_mark_num_children_asexual = enforce_dtype_stability_pandas(
    alifestd_mark_num_children_asexual_
)
