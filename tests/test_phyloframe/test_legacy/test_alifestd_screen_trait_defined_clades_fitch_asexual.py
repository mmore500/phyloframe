...
from phyloframe.legacy import (
    alifestd_screen_trait_defined_clades_fitch_asexual as alifestd_screen_trait_defined_clades_fitch_asexual_,
)
from phyloframe.legacy import (
...
alifestd_screen_trait_defined_clades_fitch_asexual = assert_dtype_consistency(alifestd_screen_trait_defined_clades_fitch_asexual_)
