...
from phyloframe.legacy import (
    alifestd_downsample_tips_lineage_asexual as alifestd_downsample_tips_lineage_asexual_,
)
from phyloframe.legacy import (
...
alifestd_downsample_tips_lineage_asexual = enforce_dtype_stability_pandas(
