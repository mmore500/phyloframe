...
def _(pfl, pl, plot_trait, simulate_trait, tp):
    def run(plot_trait):
        return (
            pfl.alifestd_make_edge_split_polars(n_leaves=100, seed=42)  # random
            ...
            .with_columns(
                trait=pl.col("ancestor_id").map_batches(  # add trait col
